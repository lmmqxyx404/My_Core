...
import (
	...
	"github.com/lmmqxyx404/my_core/common/log"
	"github.com/lmmqxyx404/my_core/common/serial"
)

// anchor4: the following string could influence the errors_test package
const trim = len("github.com/lmmqxyx404/my_core/")
